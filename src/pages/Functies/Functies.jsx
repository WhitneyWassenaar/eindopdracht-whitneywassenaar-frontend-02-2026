...
function Functies() {
    return (
        <>
            <Hero
                title={"Voorop in galop, dankzij slimme functies!"}
            ...
            <FeatureCard
                ...
                articleClassName={"feature-card feature-card--reverse"}
                imgUrl={featureImg1}
                imgAlt={"An image of a chestnut horse looking out the stable"}
                ellipseClassName={"ellipse ellipse--feature"}>
                <ul>
